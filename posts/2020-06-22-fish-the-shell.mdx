...
![Using fish abbreviations, commands expand as I type the abbreviations to let other know what you are doing and keep you give sense to your history.](/posts/fish-abbreviations.gif)
...
![program doesn't exists](/posts/fish-doesnt-exist.png)

Showing darker blue for the program and lighter blue for its arguments

![darker blue for program and lighter blue for its arguments](/posts/fish-syntax-highlight.png)
...
![using kp to kill a sleep program running forever](/posts/fish-kp.gif)
...
![my custom fish theme is quite simple](/posts/fish-oh-my-fish-shell.png)
...
![default auto complete](/posts/fish-autocomplete.png)

But if you, like me, miss the `ctrl+r` history search from bash and zsh, you can add it to fish.

![fzf auto complete](/posts/fish-querying-history.png)
